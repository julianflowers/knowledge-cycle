...
phe_tweets <- rtweet::get_timeline("PHE_uk", n = 3200)

class(phe_tweets)

tweetstophe <-  rtweet::search_tweets("@PHE_uk", n = 18000, include_rts = TRUE, retryonratelimit = TRUE)
...
cos_sim = sim2(x = word_vectors, y = word_vectors["duncan", , drop = FALSE], 
